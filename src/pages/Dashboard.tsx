...
const Dashboard = () => {
  ...
  const token = searchParams.get("token") || "ZEN";
  ...
  // Simulating a recently completed scan
  const hasRecentScan = token ? true : false;
          ...
          <>
            ...
            <div className="container mx-auto px-4 py-8">
              ...
              <Tabs value={activeTab} onValueChange={handleTabChange} className="mb-8">
                ...
                {/* Other Tabs (For MVP we'll leave these as placeholders) */}
